      ...
      <section class="section fullwidth-page bg-image" style="background-image: url(/resources/images/bg-01.jpg);">
        <div class="fullwidth-page-inner">
          <div class="section-md text-center">
            <div class="shell">
              <p class="breadcrumbs-custom-subtitle">Sorry, Bad Request</p>
              <p class="heading-1 breadcrumbs-custom-title">error 400</p>
              <p>The request could not be understood by the server due to malformed syntax.</p><a class="button button-secondary" href="/"> back to home page</a>
            </div>
          </div>
          <!-- Page Footer-->
