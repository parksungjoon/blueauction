        ...
        <div class="fullwidth-page-inner">
          <div class="section-md text-center">
            <div class="shell">
              ...
              <p>Sorry, we're offline right now to make our site even better. <br class="veil reveal-sm-inline">Please, come back later and check what we've been up to.</p>
              <div class="group-md button-group"><a class="button button-secondary" href="/"> back to home page</a><!-- <a class="button button-default-outline" href="contacts.html"> contact us</a> --></div>
            </div>
          </div>
          <!-- Page Footer-->
