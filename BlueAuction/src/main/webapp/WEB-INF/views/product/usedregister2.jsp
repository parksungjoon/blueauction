                ...
                <div class="cell-sm-8 cell-md-6 cell-lg-4">
                  ...
                  <form class="rd-mailform rd-mailform-small" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
                    <div class="form-wrap form-wrap-validation">
                      <input class="form-input" id="form-1-email" type="text" name="seller" data-constraints="@Required">
                      <label class="form-label" for="form-1-email">판매자</label>
                    </div>
                    <div class="form-wrap form-wrap-validation">
                      <input class="form-input" id="form-1-username" type="text" name="salemotive" data-constraints="@Required">
                      <label class="form-label" for="form-1-username">판매 사유</label>
                    </div>
                    <div class="form-wrap form-wrap-validation">
                      <input class="form-input" id="form-1-password" type="text" name="usingtime" data-constraints="@Required">
                      <label class="form-label" for="form-1-password">사용 기간</label>
                    </div>
                    <div class="form-wrap form-wrap-validation">
                      <input class="form-input" id="form-1-password-confirm" type="text" name="price" data-constraints="@Required">
                      <label class="form-label" for="form-1-password-confirm">가격</label>
                    </div>
                  </form>
                </div>
              </div>
                ...
                <div class="cell-sm-8 cell-md-6 cell-lg-4">
                  ...
                  <form class="rd-mailform rd-mailform-small" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
                    ...
                    <div class="form-button">
                      <button class="button button-block button-secondary" type="submit">등록</button>
                    </div>
                  </form>
                </div>
              </div>
