      ...
      <section class="section section-lg bg-white">
        ...
        <div class="shell">
              ...
              <div class="table-novi table-custom-responsive">
                <table  class="table table-striped table-hover">
                  ...
                  <c:forEach var="bid" items="${map.bidList}" varStatus="status">
                    <tr style = "cursor:pointer;" onClick = " location.href='/product/auction/${map.productList[status.index].productId}' ">
          ...
          <div style="text-align: center;">
            ...
            <li class="prev"><a
              href="/bid/mypage/bidlist/${pageMaker.startPage-1}/${pageMaker.cri.getPerPageNum()}">이전목록</a></li>
          </c:if>

          <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
            <li <c:out value="${pageMaker.cri.page==idx?' class=active':''}"/>>
            <a href="/bid/mypage/bidlist/${idx}/${pageMaker.cri.getPerPageNum()}">${idx}</a>
            </li>
          </c:forEach>

          <c:if test="${pageMaker.next && pageMaker.endPage>0}">
            <%-- <li><a href="/member/mypage/note/list${pageMaker.makeSearch(pageMaker.endPage+1)}">다음목록</a></li> --%>
            <li><a href="/bid/mypage/bidlist/${pageMaker.endPage+1}/${pageMaker.cri.getPerPageNum()}">다음목록</a></li>
          </c:if>
