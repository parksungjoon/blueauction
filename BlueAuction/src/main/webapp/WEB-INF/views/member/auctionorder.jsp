  ...
  <div class="page">
    ...
    <div class="shell">
      ...
      <ul class="breadcrumbs-custom-path">
        ...
        <li class="active">auction sell list</li>
      </ul>
    </div>
    </section>
    <!-- Breadcrumbs END -->
...
<div style="text-align: center;">
            ...
            <li class="prev"><a
              href="/member/mypage/auctionorder/${pageMaker.startPage-1}/${pageMaker.cri.getPerPageNum()}">이전목록</a></li>
          </c:if>

          <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
            <li <c:out value="${pageMaker.cri.page==idx?' class=active':''}"/>>
            <a href="/member/mypage/auctionorder/${idx}/${pageMaker.cri.getPerPageNum()}">${idx}</a>
            </li>
          </c:forEach>

          <c:if test="${pageMaker.next && pageMaker.endPage>0}">
            <%-- <li><a href="/member/mypage/note/list${pageMaker.makeSearch(pageMaker.endPage+1)}">다음목록</a></li> --%>
            <li><a href="/member/mypage/auctionorder/${pageMaker.endPage+1}/${pageMaker.cri.getPerPageNum()}">다음목록</a></li>
          </c:if>
